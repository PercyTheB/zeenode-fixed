                ...
                if regex:
                    if len(regex2) == 16 or len(regex2) == 24:
                        ...
                        if "subscription_plan" in status:
                            print(
                                f"{Fore.LIGHTBLACK_EX}[{Fore.LIGHTGREEN_EX}{time}{Fore.LIGHTBLACK_EX}] {Fore.LIGHTBLACK_EX}[{Fore.LIGHTGREEN_EX}+{Fore.LIGHTBLACK_EX}] {Fore.WHITE}Someone sent nitro gift code ({Fore.LIGHTGREEN_EX}{regex2}{Fore.WHITE}). I claimed it!"
                            )
                        else:
                            print(
                                f"{Fore.LIGHTBLACK_EX}[{Fore.LIGHTRED_EX}{time}{Fore.LIGHTBLACK_EX}] {Fore.LIGHTBLACK_EX}[{Fore.LIGHTRED_EX}-{Fore.LIGHTBLACK_EX}] {Fore.WHITE}Someone sent nitro gift code ({Fore.LIGHTRED_EX}{regex2}{Fore.WHITE}). But it was claimed.{Fore.RESET}"
                            )
            except:
                pass
        else:
