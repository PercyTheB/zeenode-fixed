...
class load:
        ...
        async def on_ready():
            ...
            print(
                f"""{Fore.RESET}
                            ...
                            {Fore.WHITE}║ {Fore.LIGHTGREEN_EX}╔═╝ ║╣  ║╣  ║║║ ║ ║  ║║ ║╣  {Fore.WHITE}║ 
                            {Fore.WHITE}║ {Fore.WHITE}╚═╝ ╚═╝ ╚═╝ ╝╚╝ ╚═╝ ═╩╝ ╚═╝ {Fore.WHITE}║
                            {Fore.WHITE}╚═════════════════════════════╝
                   ...
                   {Fore.WHITE}Zeenode's prefix is {Fore.LIGHTGREEN_EX}{prefix}{Fore.WHITE}, for command-list type {Fore.LIGHTGREEN_EX}{prefix}help{Fore.WHITE}.
                              {Fore.WHITE}[{nsign}{Fore.WHITE}] {Fore.WHITE}Nitro Sniper is {nsniper}{Fore.WHITE}.
                              {Fore.WHITE}[{gsign}{Fore.WHITE}] {Fore.WHITE}Giveaway Sniper is {gsniper}{Fore.WHITE}.
    ...
    def check_token(self, authorization):
        ...
        if r.status_code == 200:
            ...
            print(
                "Check /zeenode/config.py file to setup auto-login with token (If you have already set token there please make sure token is valid)"
            )
